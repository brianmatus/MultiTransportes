...
class BusAddWindow extends JFrame {
    ...
    public BusAddWindow(JTable modelTable, ParkingSpace theParkingSpace) {
        ...
        JLabel jcomp12 = new JLabel("Costo por día");
        costPerDayTextBox = new JTextField (5);
        JLabel jcomp14 = new JLabel("Agregar Bus");
        ...
        addButton.setBounds (155, 160, 100, 20);
        ...
        jcomp12.setBounds (10, 270, 100, 25);
        ...
        addButton.addActionListener(e-> {
            ...
            if (code.trim().length()==0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Código inválido");
                return;
            }

            String name = nameTextField.getText();
            if (code.trim().length()==0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Nombre inválido");
                return;
            }

            int passengerCapacity = Integer.parseInt(passengerCapacityTextBox.getText());
            if (passengerCapacity<=0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Capacidad Pasajeros inválida");
                return;
            }
            ...
            if (tankCapacity<=0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Capacidad Tanque inválida");
                return;
            }
            ...
            if (maxVelocity<=0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Velocidad inválida");
                return;
            }
            ...
            if (brand.trim().length()==0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Marca inválida");
                return;
            }

            int costPerDay = Integer.parseInt(costPerDayTextBox.getText());
            if (costPerDay<=0) {
                JOptionPane.showMessageDialog(BusAddWindow.this, "Costo inválido");
                return;
            }
            ...
            VehicleHandler.addVehicle(
                    new Bus(code,name,tankCapacity,passengerCapacity,brand,costPerDay,maxVelocity, theSlotCode)
            );
            modelTable.repaint();
            dispose();
